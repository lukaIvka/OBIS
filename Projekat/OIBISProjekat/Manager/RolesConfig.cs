...
namespace Manager
{
    ...
    {
        static string path = @"C:\Users\User\OneDrive\Desktop\Newfolder\Replikacija\OIBISProjekat\Manager\RolesConfigFile.resx";
        public static bool GetPermission(string rolename, out string[] permissions)
        {
            permissions = new string[10];
            var permissionString = (string)RolesConfigFile.ResourceManager.GetObject(rolename);
